<template>
    ...
    <input ref="inputRef" type="number" :value="value" @input="handleInput" @change="handleChange"
...
export default {
    ...
    computed: {
        ...
        errorDefaultText() {
            return this.errorContent ? this.errorContent : `Il numero deve essere tra ${this.validation?.min !== undefined ? this.validation.min : '0'} a ${this.validation?.max !== undefined ? this.validation.max : '255'}.`
        },
        classValidator() {
